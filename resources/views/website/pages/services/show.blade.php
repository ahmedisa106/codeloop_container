                    ...
                    <div class="service-details__left">
                        ...
                        <div class="service-details__need-help">
                            ...
                            <div class="service-details__need-help-contact">
                                <p>اتصل بنا</p>
                                <a href="tel:{{isset($setting)?$setting->mobile:''}}">{{isset($setting)?$setting->mobile:''}}</a>
                            </div>
                        </div>
                        <div class="service-details__banner">
                            <div class="service-details__banner-content">
                                ...
                                <div class="service-details__banner-shape-1 float-bob-y"><img
                                        src="{{asset('assets/website')}}/images/backgrounds/service-details-banner-shape-1.png" alt=""></div>
                            </div>
                            <div class="services-details__banner-car float-bob-x">
                                <img src="{{asset('assets/website')}}/images/resources/service-details-banner-car.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
