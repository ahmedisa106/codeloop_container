...
'website_name'=>isset($setting)?$setting->name:'',
'main_color'=>"#0172b8",
'second_color'=>"#d6e0ea",
'social_links'=>[
'facebook_link'=>isset($setting)?$setting->facebook:'',
'twitter_link'=>'',
'instagram_link'=>isset($setting)?$setting->instagram:'',
'youtube_link'=>"",
'telegram_link'=>"",
'linkedin_link'=>"",
'whatsapp_link'=>"",
...
'website_icon'=>isset($setting)?$setting->image:'' , //lite
'website_icon_url'=>isset($setting)?$setting->image:'', //lite
'website_logo'=>isset($setting)?$setting->image:'', //lite
'website_cover'=>isset($setting)?$setting->image:'',  //lite
'phone'=>isset($setting)?$setting->mobile:'',
