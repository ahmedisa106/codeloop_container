        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="{{route('containers.bulkDelete')}}" id="delete_all_form" method="post">
                        @csrf
                        <table class="table table-bordered datatable text-center">
                            ...
                            <tr>
                                ...
                                <th>التصنيف</th>
                                <th>السعر</th>
                                @permission(['delete_containers', 'update_containers'])
                                <th>العمليات</th>
                                @endpermission
                            </tr>
                            </thead>
