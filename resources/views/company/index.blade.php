                    ...
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">المشرفين</h6>
                                <h4 class="mb-0 counter">{{$data['admins_count']}}</h4>
                            </div>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card bg-2">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">الموظفين</h6>
                                <h4 class="mb-0 counter">{{$data['employees_count']}}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                ...
                                <h4 class="mb-0 counter">{{$data['containers_count']}}</h4>
                            </div>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card bg-4">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">الإيجارات</h6>
                                <h4 class="mb-0 counter">{{$data['rent_count']}}</h4>
                            </div>
