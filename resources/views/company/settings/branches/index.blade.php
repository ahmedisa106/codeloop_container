        ...
        <div class="card">
            <div class="card-header">
                ...
                <!--   <div class="dropdown-basic">
                    ...
                    <a href="{{route('branches.create')}}" data-model_title="الفروع" class="btn btn-primary show_modal btn-air-primary btn-icon ">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="{{route('branches.bulkDelete')}}" id="delete_all_form" method="post">
                        @csrf
                        <table class="table table-bordered datatable text-center">
                            ...
                            <tr>
                                ...
                                <th>عنوان الفرع</th>
                                <th>الشعار</th>
                                @permission(['delete_branches', 'update_branches'])
                                <th>العمليات</th>
                                @endpermission
                            </tr>
                            </thead>
