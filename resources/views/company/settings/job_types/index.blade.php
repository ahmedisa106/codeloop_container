        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btns-header">
                    ...
                    <a href="{{route('job-types.create')}}" class="btn btn-primary show_modal btn-air-primary btn-icon ">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="{{route('job-types.bulkDelete')}}" id="delete_all_form" method="post">
                        @csrf
