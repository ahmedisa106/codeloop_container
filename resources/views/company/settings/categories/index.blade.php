        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btns-header">
                    ...
                    <a href="{{route('categories.create')}}" data-model_title="الفروع" class="btn btn-primary show_modal btn-air-primary btn-icon ">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="{{route('categories.bulkDelete')}}" id="delete_all_form" method="post">
                        @csrf
                        <table class="table table-bordered datatable text-center">
                            ...
                            <tr>
                                ...
                                <th>إسم التصنيف</th>
                                <th>وحده القياس</th>
                                @permission(['delete_categories','update_categories'])
                                <th>العمليات</th>
                                @endpermission
