        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btns-header">
                    ...
                    <a href="{{route('category-sizes.create')}}" data-model_title="الفروع" class="btn btn-primary show_modal btn-air-primary btn-icon ">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="{{route('category-sizes.bulkDelete')}}" id="delete_all_form" method="post">
                        @csrf
