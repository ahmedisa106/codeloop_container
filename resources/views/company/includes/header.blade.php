            ...
            <!-- <li class="onhover-dropdown">
                    ...
                    <div class="onhover-show-div notification-dropdown">
                        ...
                        <ul class="custom-scrollbar">
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-primary"><img src="{{asset('assets/dashboard')}}/images/man.png" alt="">
                                    </div>
                            ...
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-secondary"><img src="{{asset('assets/dashboard')}}/images/teacher.png" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-info"><img src="{{asset('assets/dashboard')}}/images/teenager.png" alt="">
                                    </div>
                                    <div class="media-body">
                ...
                <li class="profile-nav onhover-dropdown">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        @role('admin')
                        <li><a class="show_modal" href="{{route('company-settings.index')}}"><i class="fa fa-user"></i><span>الملف الشخصي</span></a></li>
                        @endrole
                        <li><a href="javascript:void();" onclick="$('#logout_form').submit()"><i class="fa fa-sign-out"> </i><span>تسجيل خروج</span></a></li>
                        <form id="logout_form" action="{{route('company.logout')}}" method="post">
                            @csrf
                        </form>
                    </ul>
                </li>
