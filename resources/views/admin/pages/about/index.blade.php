    ...
    <div class="card-body">
        <form class="row form" method="post" action="{{route('about.store')}}" enctype="multipart/form-data">
            ...
            <div class="col-md-12 form-group">
                ...
                <input value="{{isset($about) ? $about->title:''}}" name="title" class="form-control" type="text" placeholder="">
            </div>
            <div class="col-md-12 form-group">
                <label class="form-label">التفاصيل</label>
                <textarea name="description" class="editor" id="" cols="203" rows="10">{!! isset($about)?$about->description:'' !!}</textarea>
            </div>
