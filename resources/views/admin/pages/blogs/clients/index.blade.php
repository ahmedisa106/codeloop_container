    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="btns-header">
                ...
                <a href="{{route('clients.create')}}" class="btn btn-primary show_modal btn-air-primary btn-icon">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form id="delete_all_form" action="{{route('clients.bulkDelete')}}" method="post">
                    @csrf
