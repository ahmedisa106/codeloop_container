<div class="card">
    ...
    <div class="card-body">
        <form class="row form" method="post" action="{{route('sliders.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-12-group">
                <div class="row">
                    ...
                    <div class="col-md-1  form-group">
                        <img id="pic-prev" src="{{isset($slider)? $slider->image : asset('default/default.png')}}" class="out-img"/>
                    </div>
                </div>
